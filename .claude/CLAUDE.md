...
- **Content:** A Docusaurus project, book on the project level root physical-ai-book/docs/ 
- /module-1-ros2           
   chapter-1-nervous-system.md, chapter-2-ros-communication.md, chapter-3-digital-brain-to-body.md            

- /module-2-digital-twin: chapter-1-why-simulate-physical-ai.md, chapter-2-physics-and-sensors.md, chapter-3-human-robot-interaction.md

-  /module-3-ai-robot-brain: chapter-1-perception-and-synthetic-data.md, chapter-2-vslam-and-navigation.md, chapter-3-training-the-humanoid-brain.md                                                                 

- /module-4-vision-language-action: chapter-1-voice-to-intent.md, chapter-2-language-to-action-planning.md, -3-the-autonomous-humanoid.md
  - **Modules:** 4 modules
...
- **Backend:** Python 3.11+
- **Frontend:** TypeScript/JavaScript (Docusaurus React.js)
- **Build Tools:** Node.js
- **Frameworks:**
  - FastAPI (backend api build only)
  - Docusaurus (frontend)
  - OpenAI Agents SDK
